        ...
        <div class="form-group">
            ...
            <?php echo Form::date('tanggal_lahir', !empty($siswa)?
        ...
        <div class="form-group">
            ...
            <div class="radio">
            <label for=""><?php echo Form::radio('jenis_kelamin', 'L'); ?>Laki-Laki</label>
            </div>
            <div class="radio">
            <label for=""><?php echo Form::radio('jenis_kelamin', 'P'); ?>Perempuan</label>
            </div>
        ...
        <div class="form-group">
        <?php endif; ?>
        <?php echo Form::label('nomor_telepon', 'Nomor Telepon :', ['class'=>'control-label']); ?>
        ...
        <div>
        <?php if($errors->any()): ?>
        <div class="form-group <?php echo e($errors->has('hobi')? 'has-error':'has-success'); ?>">
        <?php else: ?>
        ...
        <?php if(count($list_hobi) > 0): ?>
            <?php $__currentLoopData = $list_hobi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="checkbox">
                <label for=""><?php echo Form::checkbox('hobi_siswa[]', $key, null); ?><?php echo e($value); ?></label>
                </div>
